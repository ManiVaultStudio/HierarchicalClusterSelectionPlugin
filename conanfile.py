...
class HierarchicalClusterSelectionPluginConan(ConanFile):
    ...
    def build(self):
        ...
        # The HierarchicalClusterSelectionPlugin build expects the HDPS package to be in this install dir
